...
tex_path = './referee_changes/JANUARY_FINAL_RESULTS/table_2_body.tex'
...
df = df.rename(columns={'NU':'nu', 'rMean':'r_mag', 'PER':'period', 
                'odr slope':'cmd_slope', 'odr slope error':'cmd_slope_err',
                'intercept':'cmd_intercept', 'intercept error':'intercept_err',
                'angle':'cmd_angle', 'angle error':'angle_error', 
                'pythag':'cmd_vector_length'})
