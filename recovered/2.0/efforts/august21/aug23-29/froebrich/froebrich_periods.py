def match_to_file(our_results, froebrich_raw, outfile):
    ...
    our_pers = np.array(results_df['PER'])
...
def plot_comparisons(fro_csv, bhard_csv):
    ...
    #plt.show()
    plt.savefig('/home/thaddaeus/FMU/HRL/LAH2.0/efforts/september21/6-12/misc/period_comparison.png', dpi=200, bbox_inches='tight')
    
our_results = '/home/thaddaeus/FMU/HRL/LAH2.0/efforts/august21/AUGUST_FINAL_RESULTS/merged.csv'
froebrich_raw = '/home/thaddaeus/FMU/HRL/LAH2.0/efforts/august21/aug23-29/froebrich/froebrich_raw_data.txt'
outfile = 'bhard_matched.csv'
bhard_csv = '/home/thaddaeus/FMU/HRL/LAH2.0/efforts/kappa/Bhardwaj_comparison/Bhardwaj_results.csv'

#match_to_file(our_results, froebrich_raw, 'matched.csv')
#redo_bhard_match(our_results, bhard_csv, outfile)

plot_comparisons('matched.csv', 'bhard_matched.csv')
