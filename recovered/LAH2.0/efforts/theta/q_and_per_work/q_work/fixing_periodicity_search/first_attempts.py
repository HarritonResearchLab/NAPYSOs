...
q_m_and_ls(key=key_file,data_temp=data_temp,dv=0.03,min_per=0.1,max_per=250,pti=['0.45:0.55','0.95:1.05','26:30'],false_alarm_levels=[0.1,0.05,0.01],out_type=plot_path,report_file=report_file)